...
/** Fire real third-party requests so the kill switch has something to drop. */
...
export async function probeDecoy(path: string) {
  ...
  // Same-origin fetch is allowed by the guard; log the probe here when SW isn't controlling.
